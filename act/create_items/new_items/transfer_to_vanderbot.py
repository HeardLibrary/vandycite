...
image_data_directory = '/users/baskausj/github/vandycite/act/create_items/new_items/'
works_data_directory = '/users/baskausj/github/vandycite/act/create_items/new_items/'
...
works_metadata = pd.read_csv(works_data_directory + 'new_act_artworks.csv', na_filter=False, dtype = str) # Don't make the Q IDs the index!
...
works_ip_status = pd.read_csv(works_data_directory + 'artwork_metadata.csv', na_filter=False, dtype = str)
...
works_metadata.to_csv(works_data_directory + 'new_act_artworks.csv', index = False)
print('done')
print()
