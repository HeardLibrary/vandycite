...
for outfile in outfiles:
    if 'ignore' in outfile:
        outfile_names = outfile['ignore']
    else:
        outfile_names = []
    if outfile['manage_descriptions']:
        process_file(True, outfile['label_description_language_list'], outfile['output_file_name'], outfile['prop_list'], outfile_names)
    else:
        process_file(False, [default_language], outfile['output_file_name'], outfile['prop_list'], outfile_names)
    print()
print('done')
